...
public class MainPage extends javax.swing.JFrame {
    ...
    private void LogUpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogUpButtonActionPerformed
        ...
        if(signUpUsernameField.getText().equals("")||signUpNameField.getText().equals("")||signUpEmailField.getText().equals("")
           ||signUpPasswordField.getText().equals(""))
        ...
        else if (!signUpCardNumberField.getText().equals("10000")){
                emptyField.setText("*Amount must be equal to 10000");
        }
        else {
            ...
            if(test == 19){
                ...
                signUpCardNumberField.setText("10000");
                emptyField.setText("");
            }
        }
    ...
    private void buyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyButtonActionPerformed
        ...
        warningLabel.setText("Please Sign In first.");
            ...
            if(Integer.parseInt(billLabel.getText())>account.getBalance()){
                jLabel5.setText("Insufficient Balance!");
                billLabel.setText(":");
                jLabel4.setText("you only have" + " " + account.getBalance() + " left" );
            } else {
            Date date = new Date();
            JFrame da = new DeliveryAddress(logger, Integer.parseInt(billLabel.getText()), date.toString());
            da.setVisible(true);
            String[] temp = new String[]{(billLabel.getText())};
             sendInfo(temp);
            }
            try {
                int amount = Integer.parseInt(billLabel.getText());
...
//        });
    ...
    public Account account = new Account(logger);
}
